...
const TOKEN_NAME = "TimCoin";
const TOKEN_SYMBOL = "TIM";
const TOKEN_DESCRIPTION = "A token for Tims";
const TOKEN_IMAGE_NAME = "timCoin.jpeg"; // Replace unicorn.png with your image name
